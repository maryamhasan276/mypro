...
import kotlinx.android.synthetic.main.activity_lec_edit_profile.*
...
class lec_edit_profile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_lec_edit_profile)
        setEventsListeners()
        ...
        try {
            ...
            if (new_image) {
                ...
                withContext(Dispatchers.Main) {
                    Toast.makeText(this@lec_edit_profile, "Successfully saved", Toast.LENGTH_SHORT).show()
                    startActivity(Intent(this@lec_edit_profile, lec_edit_profile::class.java))
                }
            }
        } catch (e: Exception) {
            withContext(Dispatchers.Main) {
                Toast.makeText(this@lec_edit_profile, e.message, Toast.LENGTH_SHORT).show()
            }
        }
    }
